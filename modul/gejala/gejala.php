...
function Blank_TextField_Validator()
{
	...
	return (false);
	} else if (text_form.pertanyaan_gejala.value == "")
	{
	alert("Pertanyaan Gejala tidak boleh kosong !");
	text_form.pertanyaan_gejala.focus();
	return (false);
	} else {
	return (true);
	}
...
switch($_GET['act']){
  ...
  case "tambahgejala":
    echo "<form name=text_form method=POST action='$aksi?module=gejala&act=input' onsubmit='return Blank_TextField_Validator()'>
		  ...
		  <tr><td width=120>Pertanyaan Gejala</td><td><input type=text autocomplete='off' placeholder='Masukkan pertanyaan baru...' class='form-control' name='pertanyaan_gejala' size=30></td></tr>
  ...
  case "editgejala":
    ...
    echo "<form name=text_form method=POST action='$aksi?module=gejala&act=update' onsubmit='return Blank_TextField_Validator()'>
		  ...
		  <tr><td width=120>Pertanyaan Gejala</td><td><input autocomplete='off' type=text class='form-control' name='pertanyaan_gejala' size=30 value=\"$r[pertanyaan]\"></td></tr>
          <tr><td></td><td><input class='btn btn-success' type=submit name=submit value='Simpan' >
